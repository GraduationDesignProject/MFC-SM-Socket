...
void CclientDlg::OnBnClickedConnect()
{
	...
	f << "已连上IP为 " << strIP << " 的服务器！" << std::endl << std::endl << std::endl;

	f << "正在与服务器进行密钥协商 " << std::endl << std::endl;
	...
	f << "与服务器的共享密钥 ShareKey 为: " << ShareKey << std::endl << std::endl;
...
{	
	...
	f.open("data.txt", std::ios::app);
	f << std::endl << std::endl << "正在接收服务器发送的信息" << std::endl << std::endl;
	...
	else
	{
		...
		f << "服务器发送的密文已接收" << std::endl << std::endl;
		f << "服务器发送的签名已接收" << std::endl << std::endl;

		f << "服务器发送的签名验证成功" << std::endl << std::endl;
		f << "服务器发送的密文解密成功" << std::endl << std::endl;
...
void CclientDlg::OnBnClickedClientSend()
{
	...
	f.open("data.txt", std::ios::app);
	f << std::endl << std::endl << "正在给服务器发送信息" << std::endl << std::endl;
	...
	{  
		...
		f << "密文发送成功" << std::endl << std::endl;
		f << "签名发送成功" << std::endl << std::endl;
		f.close();
		...
		{
			m_strMessage = "您对服务器说: " + m_strMessage;
...
void CclientDlg::ReceiveFile()
{
	...
	f.open("data.txt", std::ios::app);
	f << std::endl << std::endl << "正在接收服务器发送文件" << std::endl << std::endl;
	...
	f << "服务器签名已接收" << std::endl << std::endl;
	f << "服务器签名验证成功" << std::endl << std::endl;
	...
	if (flag != 0) {
		...
		f << "服务器文件密文已接收" << std::endl << std::endl;
		f << "服务器文件密文已解密" << std::endl << std::endl;
		f.close();
	...
	//else {
	//	m_ctrMessage.AddString("标识" + CString(std::to_string(flag).c_str()));
	//}
...
void CclientDlg::OnBnClickedButton1()
{
	...
	f.open("data.txt", std::ios::app);
	f << std::endl << std::endl << "正在给服务器发送文件" << std::endl << std::endl;
	...
	f << "签名已发给服务器" << std::endl << std::endl;
	f << "文件密文已发给服务器" << std::endl << std::endl;
	f.close();
